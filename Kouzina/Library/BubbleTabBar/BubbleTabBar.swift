...
open class BubbleTabBar: UITabBar {
    ...
    private func configure() {
        backgroundColor = .clear//UIColor(hexString: "252525")
        isTranslucent = false
    ...
    private func reloadViews() {
        ...
        if #available(iOS 11.0, *) {
            buttons.first?.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 30.0).isActive = true
            buttons.last?.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -30.0).isActive = true
        } else {
            buttons.first?.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30.0).isActive = true
            buttons.last?.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -30.0).isActive = true
        }
