...
class PlatViewModel {
    ...
    static let sharedInstance = PlatViewModel()
    
    func getAll(  completed: @escaping (Bool, [Plat]?) -> Void ) {
        AF.request(HOST + "plat",
                   method: .get)
            ...
            .responseData { response in
                ...
                case .success:
                    let jsonData = JSON(response.data!)["plats"]
    ...
    func add(plat: Plat, uiImage: UIImage, completed: @escaping (Bool) -> Void ) {
